...
import streamlit as st              # For building interactive web apps easily
...
def main():
    ...
    # === LEFT COLUMN: Pie chart of club categories ===
    with col1:
    ...
    # === RIGHT COLUMN: Pie chart of recruitment status ===
    with col2:
    ...
    # === LEFT COLUMN: Member size distribution ===
    with col3:
    ...
    # === RIGHT COLUMN: Bar chart comparing member size with recruitment status ===
    with col4:
        ...
        # Convert 'numberOfMembers' to categorical type using our defined order
